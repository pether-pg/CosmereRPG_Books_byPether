...
\begin{itemize}
	\item Discord user Sharei \\
	for long and inspiring discussions about potential updates to the Enlightened Radiants' talents.
	
	\item Discord user Hannah (teawizardry)\\
	 for help with LaTeX code for talent trees. 
\end{itemize}


\section{PDF Building} 

This document was written and built in TeXstudio with MiKTeX 24.1.
