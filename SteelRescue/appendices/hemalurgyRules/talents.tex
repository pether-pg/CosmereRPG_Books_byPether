...
\newcommand{\talentSinisterIntentName}{Sinister Intent}
...
\talent
	...
	{Medicine 4+; \talentSpikeStackingName{} talent}
	{\iconConstant}
...
\talent
	...
	{
		You may chose to steal a skill your target does not have developed (eg. a specific Allomantic power). If you do, after collecting the created Spike, it gains a single Charge of that skill instead of Blessing trait.
		...
		For as long the Spike is implanted in your body, you may spend 1 Charge to make a single test of the stolen skill. Alternatively, you may spend 5 Charges to give the Spike Blessing [stolen skill +1], allowing it to grant a permanent bonus.
...
\talent
	...
	{TODO}
	{
		You may use Hemalurgy with intention to steal unique characteristics, not specified in the list of properties of each Hemalurgic metals. Work with your GM to determine if the characteristic can be stolen and which metal should be used as a spike to achieve this.		
