...
Celebrant is rather big spren city in the Cognitive Realm. The characters can explore the city and the surrounding island. 
...
\enemyGhostbloodScout{} will not attempt to start a fight with the party, but he will fight to the death if attacked. After killing him, a character can find 2d10 \lootScadrialCoin{}s and a \lootSeonTube{}.



\subsection{Port}

Here, the characters can ask about ship sailing south. The port administrator will answer all their questions. He can provide the schedule, but for the details, the PCs must ask ships' captains.
...
\scriptedOption{Improvise a climbing equipment}{
	A PC can attempt \skillCheck{17}{\skillCrafting{}} to create improvised climbing equipment from things they have.
}
...
The spren will not pursue fleeing characters, but they will fight to the end and it is impossible to leave this area with the deadeye without defeating them.
