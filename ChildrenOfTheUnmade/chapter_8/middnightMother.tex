...
\quoteBox{
	"I brought the best men I could find", you hear Brightlord \npcAdolin{} saying. "But I feel I should bring an entire army instead. You sure you want to do this now?"
}

At first, \npcShallan{} will be hesitant whether she should enter inside. If a PC would attempt to persuade her to wait (perhaps to gather more allies), she will agree without any rolls required. 
...
The PC who is confronting \npcMidnightMother{} is excluded from the ongoing combat - they can't attack or be attacked by the creatures. However, other PCs can use their actions to support them, e.g. by using Aid action.
...
Since this is quite a drastic consequence, make sure to warn the PCs not to leave \npcShallan{} alone.