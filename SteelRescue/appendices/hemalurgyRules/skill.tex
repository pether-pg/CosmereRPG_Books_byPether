...
\noindent \huge Hemalurgy \\ \Large(Intelligence) \normalsize \\ \\
...
A Hemalurgic Spike created this way has Blessing [Characteristic +Potency] and Whispers of Ruin [+X], where Characteristic is a chosen by the hemalurgist at the time of the test roll, Potency is determined by users ranks in Hemalurgy and the target's statistics, and X equals to the number of Hemalurgy ranks.
