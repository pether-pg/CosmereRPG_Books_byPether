...
\input{chapter_3/proclamation.tex}
\newpage
\input{chapter_3/bloodyStreets.tex}
\input{chapter_3/closedPalace.tex}
\input{chapter_3/battleAtTheGates.tex}
\newpage
\input{chapter_3/stormingMonastery.tex}
\newpage
\input{chapter_3/enemyReborn.tex}
\input{chapter_3/dyingSinger.tex}
...
\newpage
~ % 2nd column of the last page


\captionsetup[figure]{
	labelfont={color=white,bf,sf},
	textfont={color=white,bf,sf}
}
...
\begin{figure}[b]
	~~ \vspace{25cm} ~~
	\includegraphics{images/null.png}
	\caption{Enlightened Honorspren by BsalanderArt}
	\label{Enlightened Honorspren}
\end{figure}
	
\fancyfoot[C]{}
\AddToShipoutPictureBG*{
	\put(-50,0){
		\includegraphics[height=1.3\paperheight]{images/honorspren.jpg}
	}
}
\newpage
\clearpage
