...
While any metal weapon can be used to create a Hemalurgic Spike, a Hemalurgist may prefer to select tools designed for this purpose.
...
\scriptedOption{Precise}{
	Attacks made with this weapon gain an advantage to determine if the attack hits the target.
}
