...
If long enough time have passed since the previous queen’s proclamation read by her herald, a new one can be announced. Each proclamation starts with the same preamble:

\quoteBox{
	We, \npcQueenName{}, by the grace of Allmighty and His Heralds, Queen of the Alethkar, do herby proclaim that...
}
...
\begin{itemize}
	...
	\item People should pray to the Allmighty out in the open each day, including highstorm days, to beg for absolution and mercy for Kholinar.
	
	\item Each household should sacrifice a chul to beg the Allmighty for the King's victory over the Voidbringers on the Shattered Plains.
