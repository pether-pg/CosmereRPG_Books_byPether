...
\begin{itemize}
	\item Vira Linevych (Subliminal Unicorn) \\
	\textit{\url{https://cara.app/subliminalunicorn/all}}
\end{itemize}
...
\begin{itemize}
	\item Dion (EquilateralDamage) \\
	\textit{Final proofread to fix my numerous typos and other mistakes.} 
\end{itemize}
