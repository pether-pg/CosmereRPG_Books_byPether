...
The PCs don't need to be aware of a secret existence to attempt stealing it. Instead, the PCs might wish to loot the place in search for something useful - each time finding a new secret after gathering 0.5 successes per player.
...
\quoteBox{
	You find the following note: "It is confirmed that \locationTashikk{} Prince pushed for the prohibition of supernatural powers while under pressure from the Herald \npcNale{} himself. The Herald works to prevent the return of the Desolations. Can Vorin teaching be false...?"
}
